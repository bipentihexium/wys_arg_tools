global print_all, pass_mod, reverse_mod, test_methods, autotest_keys, test_modifications, is_message, test_key
print_all = False
...
autotest_keys = [key] if key else []
test_modifications = [pass_mod, reverse_mod]

def is_message(msg):
	return print_all or "; DATA(" in msg
